    ...
    return (
        <div>
            ...
            <div id="blobs">
                ...
                <div className="morphing-blob-2 randomized">
                ...
                <div className="morphing-blob-3 randomized">
                ...
                <div className="morphing-blob-4 randomized">
                    <svg id="visual"
                         viewBox="0 0 900 600"
                         width="900"
                         height="600"
                ...
                <div className="morphing-blob-5 randomized">
